...
- PAGINADO (revista/catálogo): además completá el objeto "revista" con tapaPags (normalmente 4), intPags (cantidad de páginas interiores que pide el cliente), tapaColores e intColores (ej. "4/4"). El sistema usa esto para armar solo los pliegos: la tapa es 1 pliego y el interior sale de las páginas (cada hoja A3 plegada = 4 páginas A4, y en la SM74 entran 2 hojas por pliego; ej. 24 páginas → 6 hojas → 3 pliegos). No calcules vos los pliegos, solo pasá las páginas.
        ...
        items: {
          ...
          items: {
            ...
            properties: {
              ...
              revista: { type: 'object', description: 'Solo para revista/catálogo/cuaderno: paginado para armar los pliegos.', properties: { tapaPags: { type: 'number' }, intPags: { type: 'number' }, tapaColores: { type: 'string' }, intColores: { type: 'string' } } },
